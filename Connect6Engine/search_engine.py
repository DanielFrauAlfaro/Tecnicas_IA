        ...
        for i in range(start_i, end_i):
            for j in reversed(range(start_j, end_j)):
                ...
                if count_d_2 == 4 and count_e_d_2 == 2:
                    ...
                    num_threats_2[2][x - y - 2] = math.inf
                    break
                ...
                if count_d2_2 == 4 and count_e_d2_2 == 2:
                    ...
                    num_threats_2[3][i - j - 2] = math.inf
                    break
